# kfp Design Review — Improvement Plan

**Date:** 2026-03-07
**Reviewing:** `2026-03-06-kfp-design.md` and `2026-03-06-kfp-implementation.md`
...
- [ ] **Option B:** Default to requiring `--rule` and remove the `-1 = all` ambiguity; add a `kfp routes <name>` summary command that lists rules without detail
